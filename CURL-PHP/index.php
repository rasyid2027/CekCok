<?php
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, 'https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCCbMMGYUTdb2KIgsW_yFHXA&key=AIzaSyC1Nnb9_oXxk3gK1-XWPASVUI9ES9-BJl8');
...
$profile = $result['items'][0]['snippet']['thumbnails']['medium']['url'];
...
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatiblse" content="IE=edge">
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-sm-6">
          <div class="row">
            <div class="col-sm-4">
              <img src="<?php echo $profile; ?>" alt="" class="img-thumbnail">
            </div>
            <div class="col-sm-8">
              <h5> <?php echo $name ?> </h5>
              <p>30 Subsribers.</p>
